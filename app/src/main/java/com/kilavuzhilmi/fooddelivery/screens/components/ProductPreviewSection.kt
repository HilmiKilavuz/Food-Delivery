...
// Gerekli Jetpack Compose bileşenlerini ve diğer kaynakları içe aktarır
...
import com.kilavuzhilmi.fooddelivery.ui.theme.AppTypography
...
private fun Content(
    ...
    ConstraintLayout(
        ...
        Image(
            painter = painterResource(id = state.productImage),
